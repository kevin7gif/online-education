...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("F:\\JavaTest\\guli-college\\guli-parent\\service\\service-order" + "/src/main/java");
        gc.setAuthor("kevin");
        ...
        strategy.setInclude("t_order","t_pay_log"); //数据库表名
